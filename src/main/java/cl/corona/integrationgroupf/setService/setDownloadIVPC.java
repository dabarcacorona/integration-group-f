...
public class setDownloadIVPC {
    ...
    @Value("${sftpos.org_IVPC}")
    private String o_sftpdtn_IVPC;
    ...
    private static final Logger LOG = LoggerFactory.getLogger(setDownloadIVPC.class);
    ...
    public void DownloadFile() throws IOException {
        ...
        try {
            ...
            Vector<ChannelSftp.LsEntry> entries = sftp.ls(o_sftpdtn_IVPC);
            ...
            for (ChannelSftp.LsEntry en : entries) {
                ...
                if (sSubCadena.equals("SDIVPCMSI")) {
                    ...
                    sftp.rm(o_sftpdtn_IVPC + en.getFilename());
